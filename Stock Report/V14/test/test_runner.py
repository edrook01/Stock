"""
Intensive Test Suite Runner for Stock Analyzer V14
...
class TestRunner:
    """Main test runner for Stock Analyzer V14."""
    
    def __init__(self):
        self.start_time = datetime.now()
        self.results: Dict[str, Dict[str, bool]] = {}
        self.entrypoint_path = entrypoint_path
        self.v14_root = v14_root
        
    def run_all_tests(self) -> Dict[str, any]:
        """Run all test suites."""
        print("\n" + "=" * 80)
        print("STOCK ANALYZER V14 - INTENSIVE TEST SUITE")
        print("=" * 80)
        ...
        try:
            ...
            print(f"\n✗ Function 1 tests failed with error: {e}")
            import traceback
            traceback.print_exc()
        ...
        print("=" * 80)
        print("  ⚠ Trading tests disabled (no linked accounts)")
        print("  ✓ Skipping Function 2 tests as requested")
        ...
        try:
            ...
            print(f"\n✗ Function 3 tests failed with error: {e}")
            import traceback
            traceback.print_exc()
    ...
    def generate_report(self) -> Dict[str, any]:
        ...
        # Save report to file
        report_path = v14_root / "test" / f"test_report_{self.start_time.strftime('%Y%m%d_%H%M%S')}.json"
        try:
