# Stock Analyzer V14 - Patch Notes

## Version 14.0 - Initial Release
...
- **Enhanced**: V13 simulator extended with V14 features
...
- **Files**: `trading/simulator_v14.py`, `trading/performance_evaluator.py`
...
- **New**: V14-specific configuration
- **New**: First-run setup
- **New**: Portability verification
- **Files**: `data/config_v14.json`, `core/setup.py`, `core/portability_check.py`
...
- Configuration file changed from `config.json` to `config_v14.json`
...
1. Copy V13 data to V14 if needed
2. Run V14 first-time setup
