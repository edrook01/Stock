"""
First-Run Setup
Detects first run and initializes V14 directory structure and configuration.
"""
...
def is_first_run() -> bool:
    """
    Check if this is the first run of V14.
...
def initialize_v14() -> Dict:
    """
    Initialize V14 on first run.
