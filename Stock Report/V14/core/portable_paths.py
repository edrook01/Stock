...
def _get_project_root() -> Path:
    """
    Get the project root (V14) by traversing up from this file's location.
    
    Returns:
        Path: Absolute path to the project root (V14 directory)
    """
    # #region agent log
    import json
    ...
    # Get the directory containing this file (V14/core/)
    current_file = Path(__file__).resolve()
    # Go up one level to get V14/
...
_PATH_TYPES: Dict[str, str] = {
    ...
    'models': 'model/models',
    'model_weights': 'model/weights',  # V14 unified model weights
...
def get_path(type: str) -> Path:
    ...
    Examples:
        >>> get_path('data')  # Returns absolute path to V14/data/
        >>> get_path('logs')  # Returns absolute path to V14/logs/
        >>> get_path('root')  # Returns absolute path to V14/
    """
    # #region agent log
    import json
    from datetime import datetime
...
def initialize_structure() -> None:
    ...
    nested_dirs = [
        ...
        'model/models',
        'model/weights',  # V14 unified model weights
    ]
...
def get_root_path() -> Path:
    """Get absolute path to project root (V14)."""
