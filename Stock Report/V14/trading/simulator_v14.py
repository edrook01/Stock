"""
V14 Enhanced Trading Simulator
Extends V13 simulator with V14 features: ATR-based stops, trailing stops, risk profiles.
"""
...
class Position:
    """Represents an open CFD position with V14 features."""
...
class TradingSimulatorV14:
    """Enhanced trading simulator with V14 features."""
    ...
    async def open_position(
        ...
        """
        Open a new position with V14 risk management.
    ...
    def save_simulation(self) -> None:
        ...
        try:
            ...
            sim_file = history_dir / 'trading_sim_v14.json'
