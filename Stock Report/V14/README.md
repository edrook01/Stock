# Stock Analyzer V14 - User Guide

## Overview

Stock Analyzer V14 is a comprehensive trading system integrating long-term investment analysis and short-term CFD trading. It combines a unified ML model with robust risk management, automated browser-based trade execution, and adaptive learning.
...
On first run, V14 will:
1. Create directory structure
2. Initialize default configuration (`data/config_v14.json`)
3. Prompt for Trading212 credentials (optional)

### Configuration File

Edit `data/config_v14.json` to customize:
...
5. **V14 Features** - V14-specific features:
...
V14 is fully portable. Simply copy the entire `V14/` folder to a new machine and run. All data, models, and logs are stored within the V14 directory using relative paths.

**Portable Components:**
- Model weights: `model/weights/`
- Trade logs: `history/`
- Configuration: `data/config_v14.json`
...
2. Configure Trading212 credentials in `data/config_v14.json` or via menu
...
V14 learns from trade outcomes:
...
- Verify V14 directory structure is intact
