...
class SentimentAnalyzer:
    ...
    def analyze(self, text: str, *, return_details: bool = False) -> Union[float, Dict[str, any]]:
        """
        Analyze sentiment and optionally return the full detail dictionary.
        
        Args:
            text: Text to analyze
            return_details: When True, return the full analysis dictionary.
            
        Returns:
            Sentiment score (float) or full analysis dictionary
        """
