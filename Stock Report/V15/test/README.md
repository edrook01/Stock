# Intensive Test Suite for Stock Analyzer V15

## Overview

This comprehensive test suite tests all 3 core functions of Stock Analyzer V15 as defined in the Project Plan:
...
The test suite automatically detects the main entrypoint (`Stock Analyzer V15.py`) by:
...
- Python 3.7+
- All V15 dependencies (pandas, numpy, etc.)
- Network access for data fetching tests
- V15 project structure intact
...
1. You're running from the V15 directory or test directory
2. The V15 root is in Python's path
